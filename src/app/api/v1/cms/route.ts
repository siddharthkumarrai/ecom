...
const PatchSchema = z.object({
  ...
  appearance: z
    .object({
      ...
      announcementFontSize: z.number().int().min(9).max(24).optional(),
      announcementFontWeight: z.enum(["400", "500", "600", "700"]).optional(),
      announcementFontStyle: z.enum(["normal", "italic"]).optional(),
      announcementTextTransform: z.enum(["none", "uppercase", "capitalize"]).optional(),
      announcementAnimation: z.enum(["none", "marquee", "pulse", "fade"]).optional(),
      navbarBg: z.string().optional(),
      navbarText: z.string().optional(),
      navbarIconColor: z.string().optional(),
      cartButtonBg: z.string().optional(),
      cartButtonHoverBg: z.string().optional(),
      cartButtonText: z.string().optional(),
      cartBadgeBg: z.string().optional(),
      footerBg: z.string().optional(),
      footerTopBg: z.string().optional(),
      footerText: z.string().optional(),
      footerMutedText: z.string().optional(),
