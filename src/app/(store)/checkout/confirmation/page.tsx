      ...
      <div className="rounded border border-zinc-200 p-6 text-center">
        ...
        {trackingUrl ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="ml-2 mt-5 inline-flex items-center justify-center rounded bg-brand-yellow px-4 py-2 font-semibold text-zinc-900 shadow-sm transition-colors hover:bg-brand-yellow-dark"
          >
            Track Order
          </a>
        ) : null}
