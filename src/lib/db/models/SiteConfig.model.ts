...
const SiteConfigSchema = new mongoose.Schema(
  {
    ...
    appearance: {
      ...
      cartButtonBg: { type: String, default: "#f5c400" },
      cartButtonHoverBg: { type: String, default: "#ffd84d" },
      cartButtonText: { type: String, default: "#1f2937" },
      cartBadgeBg: { type: String, default: "#2563eb" },
      footerBg: { type: String, default: "#f6f6f6" },
      footerTopBg: { type: String, default: "#f5c400" },
      footerText: { type: String, default: "#27272a" },
      footerMutedText: { type: String, default: "#71717a" },
