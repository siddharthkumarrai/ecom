...
export function buildDefaultHomepageSections(config: SiteConfig, autoCategorySections: AutoCategorySection[]): HomepageSection[] {
  ...
  return [
    ...
    },
    {
      ...
      config: {
        navbarBg: config.appearance.navbarBg,
        navbarText: config.appearance.navbarText,
        navbarIconColor: config.appearance.navbarIconColor,
        cartButtonBg: config.appearance.cartButtonBg,
        cartButtonHoverBg: config.appearance.cartButtonHoverBg,
        cartButtonText: config.appearance.cartButtonText,
        cartBadgeBg: config.appearance.cartBadgeBg,
        ...
        productActionButtonBg: config.appearance.productActionButtonBg,
        productActionButtonHoverBg: config.appearance.productActionButtonHoverBg,
      },
    },
    {
      id: "hero-carousel",
